...
#ifndef SRC_GPIO_LIB_I2C_SOFT_H_
#define SRC_GPIO_LIB_I2C_SOFT_H_
...
void I2C_soft_test(uint8_t uint8_t_test_address, uint8_t* uint8_t_input_buffer, uint8_t* uint8_t_output_buffer);

#endif /* SRC_GPIO_LIB_I2C_SOFT_H_ */
